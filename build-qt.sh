...
# needed because the rpath generated by qmake includes the full sysroot path
# which doesn't seem to do the job
qmake_opts="QMAKE_LFLAGS+=-Wl,-rpath,$qtdir/lib"

echo "Compiling qtbase..."
cd src
../bin/qmake -r $qmake_opts
make $make_jobs
sudo make install

echo "Compiling qtjsbackend..."
cd $basedir/qtjsbackend
$qtdir/bin/qmake -r $qmake_opts
make $make_jobs
sudo make install
